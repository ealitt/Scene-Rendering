// code adapted from LearnOpenGL chapter 6: ibl_specular (https://learnopengl.com/PBR/IBL/Specular-IBL)
// credits for basecode: Joey De Vries https://github.com/JoeyDeVries/LearnOpenGL

// runs as a standalone viewer for rendering spheres with image based lighting
// hdr images ar referenced in folder src/rendering/hdr/*.hdr
...
int main()
{
    ...
    // reference hdr images in folder src/rendering/hdr/
    int width, height, nrComponents;
    float *data = stbi_loadf(FileSystem::getPath("src/rendering/hdr/robertson.hdr").c_str(), &width, &height, &nrComponents, 0);
    ...
    // comment below to turn cube map background on/off
    // backgroundShader.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // set material values per sphere rendered
